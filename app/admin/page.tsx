export default function AdminPage() {
  return (
    <>
      ...
      <script
        dangerouslySetInnerHTML={{
          __html: `(function(){try{if(!localStorage.getItem("mcAdminToken"))location.replace("/admin/login");}catch(e){location.replace("/admin/login");}})();`,
        }}
      />
      <div id="root">
      ...
      <script src="/admin-boot.js?v=22" defer />
    </>
  );
}
